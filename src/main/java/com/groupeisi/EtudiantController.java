...
public class EtudiantController {
    ...
    private RuntimeWiring buildwiring(){
        DataFetcher<Iterable<Etudiant>>  fetcher1=data->{
        ...
        return RuntimeWiring.newRuntimeWiring().type("Query",
            typewriting-> typewriting.dataFetcher("getAllEtudiant",fetcher1).dataFetcher("findEtudiant",fetcher2)).build();
